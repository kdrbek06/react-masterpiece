    ...
    <nav className="flex item-center justify-between flex-wrap bg-gray-600 p-6">
      ...
      <div className="w-full block flex-grow sm:flex sm:items-center sm:w-auto">
        <ul className="text-sm sm:flex">
          ...
          <li><a href="/" className="block mt-4 sm:inline-block sm:mt-0 text-teal-200 hover:text-white mr-4">Reviews</a></li>
          <li><a href="/" className="block mt-4 sm:inline-block sm:mt-0 text-teal-200 hover:text-white mr-4">Collabration</a></li>
